...
class EpsilonReducer:
    def __init__(self):
        self.action_selector = ptan.actions.GreedySelector(epsilon=PARA_SHORTCUT.epsilon_start)
        self.parameters = PARA_SHORTCUT

    def reduce_by_frames(self, current_frame):
